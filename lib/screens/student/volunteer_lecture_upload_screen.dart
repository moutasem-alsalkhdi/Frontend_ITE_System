...
class VolunteerLectureUploadScreen extends StatefulWidget {
  const VolunteerLectureUploadScreen({super.key});

  @override
  State<VolunteerLectureUploadScreen> createState() => _LectureUploadScreenState();
}
    ...
    return Container(
      ...
      child: DropdownButton<int>(
        ...
        items: _courses.map((c) {
          final int courseId = int.tryParse(c['id'].toString()) ?? -1;
